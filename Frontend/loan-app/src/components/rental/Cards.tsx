...
const Cards = () => {
  return (
    <>
      ...
      <div className="bg-white py-14 rounded-2xl shadow-lg p-6 animate-slide-in-left">
        <div className="flex items-center mb-6">
      ...
      <div className="bg-white py-16 rounded-2xl shadow-lg p-6 animate-slide-in-left">
        <div className="flex items-center mb-6">
          <Info className="w-8 h-8 text-blue-600 mr-3" />
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 animate-slide-in-left mt-6">
        <div className="flex items-center mb-6">
          <Shield className="w-8 h-8 text-blue-600 mr-3" />
          <h2 className="text-2xl font-bold text-gray-900">Loan Eligibility</h2>
        </div>
        <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
          <li>At least 21 years old and a Filipino citizen</li>
          <li>Employed or with a stable source of income</li>
          <li>Valid government-issued ID</li>
          <li>Proof of billing and residence</li>
        </ul>
      </div>
