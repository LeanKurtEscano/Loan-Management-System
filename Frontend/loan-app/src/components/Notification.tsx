            ...
            <div className="flex space-x-1">
              {filterOptions.map(filter => (
                <button
                  ...
                  className={`px-3 py-1 text-sm font-medium rounded-full transition-colors ${activeFilter === filter.value
          ...
          {!isLoading && !isError && currentNotifications.map((notification) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className={`mt-1 h-8 w-8 rounded-full flex items-center justify-center ${notification.status === 'Success' ? 'bg-green-100' :
