            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex md:pl-10 items-center">
                    ...
                    <div className="grid grid-cols-2 pr-16 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold uppercase text-blue-500">
                                Resources
                            </h2>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm md:pl-11 text-black sm:text-center">
                        © 2025{" "}
                        <a href="https://flowbite.com/" className="hover:underline">
                            To-loan™
                        </a>
                    ...
                    <div className="flex mt-4 pr-16 sm:justify-center sm:mt-0">
                        ...
                        <a href="#" className="text-black hover:text-gray-700 ms-5">
