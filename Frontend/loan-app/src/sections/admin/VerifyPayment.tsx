        ...
        >
           <motion.div
                ...
                <div className="flex flex-col gap-4 items-center mb-6">
                    ...
                    <div className="relative">
                        ...
                        <img
                            ...
                            alt="Front of ID"
                            className="w-[400px] h-[500px] object-cover rounded-md shadow"
                        />
                ...
                <div className="p-6 pl-32 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-gray-700">
                        ...
                        <div>
                            ...
                            <div className="text-gray-800 font-semibold">
                                {data?.loan.cashout.charAt(0).toUpperCase() + data?.loan.cashout.slice(1).toLowerCase() || "Not provided"}
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="block font-medium">Period Paid</label>
            ...
            <Modal
                ...
                message="Are you sure you want to approve this user's payment?. Please verify that the payment has been successfully sent and that the attached receipt is valid."
