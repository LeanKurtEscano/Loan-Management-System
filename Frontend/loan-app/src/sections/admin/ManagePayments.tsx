...
const ManagePayments: React.FC = () => {
  ...
  const {
    ...
    queryFn: () => fetchPaymentsData("payments"),
  });
  ...
  const stats: StatCard[] = [
    { title: "Total Payments", value: totalApplications, icon: faMoneyBillWave, color: "from-blue-400 to-blue-600" },
    { title: "Pending Payments", value: pendingApplications, icon: faClock, color: "from-yellow-400 to-yellow-600" },
    { title: "Approved Payments", value: approvedApplications, icon: faCheckCircle, color: "from-green-400 to-green-600" }
  ];
    ...
    <div className="p-6 w-full min-h-screen max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-600">
          Review and manage payments submitted by users
        </p>
      </motion.div>
