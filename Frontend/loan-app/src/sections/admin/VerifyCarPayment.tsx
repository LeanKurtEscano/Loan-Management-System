...
const VerifyCarPayment = () => {
    ...
    const handleApprove = async () => {
        setLoading(true);
        try {
            const response = await adminCarDisbursementApi.post("/approve/payment/", {
                id: id,
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <div className="text-gray-800 font-semibold">
                                                {data?.disbursement?.application?.first_name || "Not provided"}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="text-gray-800 font-semibold">
                                                {data?.disbursement?.application?.middle_name || "Not provided"}
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="text-gray-800 font-semibold">
                                                {data?.disbursement?.application?.last_name || "Not provided"}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
export default VerifyCarPayment;