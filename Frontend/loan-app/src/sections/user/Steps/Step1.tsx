    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br ">
      <div className="bg-white p-10 rounded-3xl shadow-2xl w-[500px] h-[500px] transform transition-transform hover:scale-105 duration-300">
        ...
        <form>
          ...
          <button
            type="button"
            className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white py-4 rounded-xl font-semibold shadow-md hover:from-blue-600 hover:to-blue-700 transition-all duration-300 ease-in-out text-lg"
            onClick={nextStep}
          >
            Continue
          </button>
